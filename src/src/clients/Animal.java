...
public class Animal {
    ...
    protected void toGo(){System.out.println(getType() + " is going");}
    protected void fly(){System.out.println(getType() + " is flying");}
    protected void swim(){System.out.println(getType() + " is swimming");}
